...
const Naming = () => {
  return (
    <div>
        ...
        <meta
          name="keywords"
          content="Custom Decorations in bangalore, TAN Events,  Naming ceremony in Bangalore, Baby naming event, Naming celebration, Baby naming ceremony, Naming ritual, Infant naming ceremony, Naming ceremony traditions, Naming ceremony decorations, Naming ceremony invitations, Naming ceremony venue, Naming ceremony officiant, Naming ceremony rituals, Naming ceremony themes, Naming ceremony gifts, Naming ceremony photography, Naming ceremony catering, Naming ceremony outfits, Naming ceremony music, Naming ceremony blessings, Naming ceremony speeches,  Event planning, Event management company, Event coordination, Event organizers, Event production, Corporate event planning, Theme parties, Event decoration, Catering services, Audiovisual services, Event marketing, Event promotions, Event budgeting, Event coordination services, Event management in bangalore, Event management near me"
        />
      </Helmet>
    <Section>
